...
| Eslint 插件                                                       | [ESlint Plugin](https://eslint.org/docs/latest/extend/plugins) | [@juncern/eslint-plugin](https://www.npmjs.com/package/@juncern/eslint-plugin)             |

[@juncen/fe-lint](https://www.npmjs.com/package/@juncen/fe-lint) 收敛屏蔽了上述依赖和配置细节，提供简单的 `CLI` 和 `Node.js API`，让项目能够一键接入、一键扫描、一键修复、一键升级，并为项目配置 git commit 卡口，降低项目接入规范的成本。

您可以使用[@juncen/fe-lint](https://www.npmjs.com/package/@juncen/fe-lint) 方便地为项目接入全部规范。
