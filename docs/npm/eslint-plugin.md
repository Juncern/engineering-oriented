...
# @juncern/eslint-plugin

除了本包，你需要同时安装 [ESlint](https://eslint.org/)

```shell
$ npm install @juncern/eslint-plugin eslint --save-dev
```
...
// .eslintrc.js
module.exports = {
  plugin: ['@juncern/eslint-plugin'],
  rules: {
    '@juncern/eslint-plugin/no-secret-info': 'error',
  },
};
```
...
// .eslintrc.js
module.exports = {
  extends: 'plugin:@juncern/eslint-plugin/recommended',
};
```
...
```js
var test = 'http://coder.com';
var jsx = <img src="http://coder.com">;
```
